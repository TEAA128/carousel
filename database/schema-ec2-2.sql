...
FROM '/tmp/data3/generateUserLikes1_1.csv' DELIMITER ',' CSV HEADER;

COPY user_likes(list_id,place_id)
FROM '/tmp/data3/generateUserLikes1_2.csv' DELIMITER ',' CSV HEADER;

COPY user_likes(list_id,place_id)
FROM '/tmp/data3/generateUserLikes1_3.csv' DELIMITER ',' CSV HEADER;

COPY user_likes(list_id,place_id)
FROM '/tmp/data3/generateUserLikes1_4.csv' DELIMITER ',' CSV HEADER;
